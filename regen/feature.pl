...
This feature supported the legacy C<$[> variable.  See L<perlvar/$[> and
L<arybase>.  It was on by default but disabled under C<use v5.16> (see
L</IMPLICIT LOADING>, below) and unavailable since perl 5.28.
