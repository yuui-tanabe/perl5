...
Es	|bool	|rck_branch	|NN RExC_state_t *pRExC_state \
				|NN rck_params_t *params
Es	|bool	|rck_branchj	|NN RExC_state_t *pRExC_state \
				|NN rck_params_t *params
...
Es	|bool	|rck_exact	|NN RExC_state_t *pRExC_state \
				|NN rck_params_t *params
Es	|bool	|rck_exactfish	|NN RExC_state_t *pRExC_state \
				|NN rck_params_t *params
...
Es	|bool	|rck_simple	|NN RExC_state_t *pRExC_state \
				|NN rck_params_t *params
Es	|bool	|rck_eolish	|NN RExC_state_t *pRExC_state \
				|NN rck_params_t *params
Es	|bool	|rck_lookaround	|NN RExC_state_t *pRExC_state \
				|NN rck_params_t *params
Es	|bool	|rck_open	|NN RExC_state_t *pRExC_state \
				|NN rck_params_t *params
Es	|bool	|rck_close	|NN RExC_state_t *pRExC_state \
				|NN rck_params_t *params
